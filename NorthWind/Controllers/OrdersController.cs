...
namespace NorthWind.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var viewModel = new OrderCustomerEmployeeShipperOrderDetails();
            viewModel.Orders = await _context.Orders
                .Include(o => o.OrderDetails)
                    .ThenInclude(o => o.Product)
                        .ThenInclude(o => o.Supplier)
                .Include(o => o.Customer)
                    .ThenInclude(o => o.CustomerCustomerDemos)
                        .ThenInclude(o => o.CustomerDemographic)
                .Include(o => o.Employee)
                    .ThenInclude(o => o.EmployeeTerritories)
